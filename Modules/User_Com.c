  ...
  switch (option) {
    ...
    case 0x10:  // set motor speed pid
      ...
      if (p_data[0] & 0x01) {
        ...
        motor_l.spdPID.integral = *(p_float + 1);
        motor_l.spdPID.derivative = *(p_float + 2);
      }
      if (p_data[0] & 0x02) {
        motor_r.spdPID.proportion = *p_float;
        motor_r.spdPID.integral = *(p_float + 1);
    ...
    case 0x11:  // set motor pos pid
      ...
      if (p_data[0] & 0x01) {
        ...
        motor_l.posPID.integral = *(p_float + 1);
        motor_l.posPID.derivative = *(p_float + 2);
      }
      if (p_data[0] & 0x02) {
        motor_r.posPID.proportion = *p_float;
